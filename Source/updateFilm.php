...
<div class="form-row">
  ...
  <div class="col-md-12 mb-3">
    ...
    <div class="col-md-3 mb-3">
      ...
      <input type="text" class="form-control" id="validationCustom02" value='<?php echo $film[0]->getConcatGenre()?>' required>
      <div class="valid-feedback">
        Looks good!
      </div>
    </div>
    ...
    <div class="col-md-6 mb-3">
      ...
      <input type="text" class="form-control" id="validationCustom05" value='<?php echo $film[0]->getReal()?>' required>
    ...
    <div class="col-md-6 mb-3">
      ...
      <input type="text" class="form-control" id="validationCustom05" value='<?php echo $film[0]->getPaysReal()?>' required>
      <div class="invalid-feedback">
      Looks good!
      </div>
    </div>
    ...
    <div class="col-md-6 mb-3">
      ...
      <input type="text" class="form-control" id="validationCustom05" value='<?php echo $film[0]->getAct1()?>' required>
      <div class="invalid-feedback">
      Looks good!
      </div>
    </div>
    <div class="col-md-6 mb-3">
      ...
      <input type="text" class="form-control" id="validationCustom05" value='<?php echo $film[0]->getPaysAct1()?>' required>
      <div class="invalid-feedback">
      Looks good!
      </div>
    </div>
    ...
    <div class="col-md-6 mb-3">
      ...
      <input type="text" class="form-control" id="validationCustom05" value='<?php echo $film[0]->getAct2()?>' required>
      <div class="invalid-feedback">
      Looks good!
      </div>
    </div>
    <div class="col-md-6 mb-3">
      ...
      <input type="text" class="form-control" id="validationCustom05" value='<?php echo $film[0]->getPaysAct2()?>' required>
      <div class="invalid-feedback">
      Looks good!
      </div>
    </div>
